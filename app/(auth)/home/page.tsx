          ...
          <div className="w-full max-w-3xl mx-auto text-center space-y-8">
            <div className="space-y-4">
              <h1 className="animate-slide-up text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900">
                ...
                <span className="animate-slide-up-delay-1 block text-blue-600 mt-2">With Expert-Led Courses</span>
              </h1>
              <p className="animate-slide-up-delay-2 text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
                Access comprehensive medical courses, certification exams, and professional development resources designed for healthcare professionals.
              </p>
            </div>
            ...
            <div className="animate-slide-up-delay-3 grid grid-cols-2 md:grid-cols-3 gap-8 pt-8">
              <div className="text-center transform hover:scale-105 transition-transform duration-300">
                <div className="text-3xl font-bold text-blue-600 mb-2 animate-number">1000+</div>
                <div className="text-sm text-gray-600">Sections</div>
              </div>
              <div className="text-center transform hover:scale-105 transition-transform duration-300">
                <div className="text-3xl font-bold text-blue-600 mb-2 animate-number">50k+</div>
                <div className="text-sm text-gray-600">Units</div>
              </div>
              <div className="hidden md:block text-center transform hover:scale-105 transition-transform duration-300">
                <div className="text-3xl font-bold text-blue-600 mb-2 animate-number">98%</div>
            ...
            <div className="animate-slide-up-delay-4 flex flex-col sm:flex-row gap-4 justify-center pt-8">
              <Link href="/details" className="group px-8 py-3 bg-white text-blue-600 rounded-full font-semibold border-2 border-blue-600 transition-all duration-300 relative overflow-hidden">
                <span className="relative z-10 group-hover:text-white transition-colors">Explore Courses</span>
