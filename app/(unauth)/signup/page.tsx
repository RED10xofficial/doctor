...
export default async function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 relative overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-4 sm:p-6 lg:p-4 py-8 sm:py-12">
        <div className="w-full max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            <div className="text-center lg:text-left space-y-6 sm:space-y-8 order-2 lg:order-1 animate-fade-in">
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <p className="text-base sm:text-lg text-gray-600 leading-relaxed max-w-md lg:max-w-lg mx-auto lg:mx-0">
                  Join thousands of medical professionals advancing their
                  careers with expert-led courses, comprehensive assessments,
              ...
              <div className="grid grid-cols-3 gap-4 sm:gap-6 pt-6 sm:pt-8 max-w-sm mx-auto lg:mx-0">
            ...
            {/* Right Section - Signup Form - Enhanced responsive design */}
            <div className="flex justify-center lg:justify-end order-1 lg:order-2 animate-fade-in-delayed">
              <div className="w-full max-w-sm sm:max-w-md">
                {/* Enhanced Signup Form Container - Responsive padding and sizing */}
